...
<xsl:stylesheet 
    ...
    <xsl:template match="/" name="html_footer">
        ...
        <div class="wrapper fundament-default-footer" id="wrapper-footer-full" style="margin-top: 4em;background-color:#3A3A3A !important;color:#7b7a7a !important;">
        ...
        <!-- #wrapper-footer-full -->
        <div class="footer-imprint-bar" id="wrapper-footer-secondary" style="background-color:#3A3A3A !important;color:#7b7a7a !important;border-top:1px dotted grey;text-align:center; padding:0.4rem 0; font-size: 0.9rem;" >
            © Copyright OEAW | <a style="color:#7b7a7a !important;" href="imprint.html">Impressum/Imprint</a>
        </div>
    </xsl:template>
</xsl:stylesheet>