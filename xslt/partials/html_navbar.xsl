                        ...
                        <ul id="main-menu" class="navbar-nav" style="margin-right:0!important;">
                            <li class="nav-item dropdown">
                                ...
                                <ul class=" dropdown-menu" role="menu" style="width:20rem;">
                                    ...
                                    <li class="nav-item dropdown-submenu">
                                        <a title="Methodik" href="07-concordance.html" class="nav-link disabled" aria-disabled="true">Konkordanz</a>
                                    </li>
                                    <li class="nav-item dropdown-submenu">
                            ...
                            <li class="nav-item dropdown">
                                ...
                                <ul class=" dropdown-menu" role="menu" style="width:20rem;">
                                    ...
                                    <li class="nav-item dropdown-submenu">
                                        <a title="Kopisten nach Werk" href="toc.html" class="nav-link disabled" aria-disabled="true">Kopisten nach Werk</a>
                                    </li>
                                    <li class="nav-item dropdown-submenu">
